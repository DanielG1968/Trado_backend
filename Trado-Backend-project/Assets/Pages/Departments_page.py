...
class DepartmentsPage(Commons):
    ...
    DEPARTMENT_NAME = (U.By.CSS_SELECTOR, '#root > div:nth-child(1) > div.modal_modalWrapper.modal_open > div > div > '
                                          'form > div.form_items > '
    ...
    WERT_BRANCH = (U.By.CSS_SELECTOR, '.table_table > table:nth-child(1) > tbody:nth-child(2) > tr:nth-child(3) > '
                                      'td:nth-child(2)')
